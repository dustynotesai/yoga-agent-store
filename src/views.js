...
function layout(
  ...
  ${body}
  <footer class="foot"><div class="footer-top"><div class="footer-brand"><a class="brand" href="/">${mountain}<span>mountain flow<small>YOGA & EVERYDAY</small></span></a><div class="creator-links"><a class="creator-credit" href="https://github.com/dustynotesai">Built by <span>DustyNotes</span> <span aria-hidden="true">↗</span></a><a class="creator-credit" href="https://www.youtube.com/@DustyNotesAI">YouTube <span>@DustyNotesAI</span> <span aria-hidden="true">↗</span></a></div></div><p>練習，是回到自己的路。<br><span class="muted">Find a little room to move.</span></p><div class="footer-links"><a href="/#collection">探索商品 ${arrow}</a><a href="/about">關於山流 ${arrow}</a></div></div>
